...
public class ReliableRobot implements Robot {
    /*
     * Create class variables for:
     *    - Battery
     *    - Energy Cost constants
     *    - Maze variable
     *    - StatePlaying (access its methods)
     *    - Exit Coordinates
     ...
     *    the state, control passes this job to StatePlaying. 
     *    
	...
	public int[] getCurrentPosition() throws Exception {
		/*
		 * Use the Control class's getCurrentPoisition() method.
	...
	public int getOdometerReading() {
		/*
		 * An odometer variable stores the odometere reading which is returned
